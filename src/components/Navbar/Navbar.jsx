                ...
                <div className='container'>
                    <div className='navbar-content'>
                        <div className='brand-and-toggler flex flex-sb'>
                            <Link to= "/" className='navbar-brand text-uppercase fw-7 text-white ls-2 fs-22'>Anne Alaniz</Link>
                            ...
                            <div className={navToggler ? "navbar-collapse show-navbar-collapse" : "navbar-collapse"}>
                                ...
                                <ul className='navbar-nav'>
                                    ...
                                    <li className='nav-item'>
                                        <Link to = "/" className='nav-link text-white ls-1 text-uppercase fw-6 fs-22'>Livros Publicados</Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link to = "/" className='nav-link text-white ls-1 text-uppercase fw-6 fs-22'>Bienal 2022</Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link to = "/" className='nav-link text-white ls-1 text-uppercase fw-6 fs-22'>Sobre Mim</Link>
                                    </li>
                                    <li className='nav-item'>
                                        <Link to = "/" className='nav-link text-white ls-1 text-uppercase fw-6 fs-22'>Contato</Link>
                                    </li>
                                </ul>
                            </div>
                        </div>
